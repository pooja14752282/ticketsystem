...
<div style="background:#fff;border-radius:10px;border:1px solid #e5e7eb;padding:24px;max-width:500px;">
    <h1 style="font-size:18px;font-weight:600;color:#111827;margin-bottom:20px;">👤 Add Support Team Member</h1>
    ...
    <form action="{{ route('admin.support-team.store') }}" method="POST">
        ...
        <div style="margin-bottom:16px;">
            ...
            <input type="text" name="name" value="{{ old('name') }}"
                   style="width:100%;padding:8px 12px;font-size:13px;border:1px solid #d1d5db;border-radius:6px;outline:none;box-sizing:border-box;"
